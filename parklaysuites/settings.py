"""
Django settings for parklaysuites project.
"""
...
SECRET_KEY = 'django-insecure-dummy-key-change-this-in-production'
...
STATIC_URL = 'static/'
# Explicitly tell Django where to find your static folder
STATICFILES_DIRS = [
